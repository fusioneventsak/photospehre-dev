          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-gradient-to-br from-green-900/30 to-black/50 backdrop-blur-sm p-6 rounded-lg border border-green-500/20">
                ...
                <p className="text-gray-400 text-sm">Full moderation controls - you decide what images are displayed. Add text to images using our built-in mobile photobooth. Coming soon: AI photo generation!</p>
