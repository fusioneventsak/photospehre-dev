...
const PhotoboothPage: React.FC = () => {
  ...
  const uploadToCollage = useCallback(async () => {
    ...
    console.log('📤 Starting photo upload to collage...');
    setUploading(true);
    setError(null);
    setIsEditingText(false);
    ...
    try {
      ...
      console.log('📤 Uploading photo with embedded text...');
  ...
  }, [photo, currentCollage, textElements, renderTextToCanvas, uploadPhoto, startCamera, selectedDevice]);
